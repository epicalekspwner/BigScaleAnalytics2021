...
| **Model**                   | **Parameters**                                                      |**Internal Accuracy/R² or Google Cloud Precision/Recall/R²**|  **Accuracy Aicrowd submission**|**Evaluation**|
|----------------------------------------------------------|-------------------------------------------------------------------------------|------------------------|------------|--------------------------|
**Regression Algo (RA) 📈 📉**   
| `**Linear regression (1)**`  |param: `None`|R²: 0.31|`None`|`None`|
| `**Logistic regression (2)**`    |param: standardization, penalty = 'l2',solver='lbfgs', cv=8, max_iter=3000, random_state=72|R²: 0.37|`None`|`None`|             
| `**Support vector machine Regression (3)**` |param: StandardScaler(), SVR(C=5, epsilon=0.8), round()|R²: 0.46|Accuracy: 0.49|`None`|
||||||
**Regression Algo Camembert package (RACAM) 📈 📉 🧀**   
| `**Linear regression (1)**`  |param: `None`|R²: 0.36|`None`|`None`|
| `**Logistic regression (2)**`    |param: standardization, penalty = 'l2',solver='lbfgs', cv=8, max_iter=3000, random_state=72|R²: 0.41|`None`|  `None`|           
